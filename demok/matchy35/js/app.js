    ...
    form.addEventListener('submit', function (e) {
      ...
      fetch(ENDPOINT, {
        ...
        .then(function (res) {
          ...
          form.reset();
          setStatus(status, 'ok', 'Köszönjük, hamarosan válaszolunk!');
        })
        .catch(function () {
          setStatus(status, 'err', 'Most nem sikerült elküldeni. Hívj bátran telefonon vagy Instagramon.');
        })
